...
Status CameraService::makeClient(const sp<CameraService>& cameraService,
        ...
        int servicePid, int halVersion, std::pair<int, IPCTransport> deviceVersionAndTransport,
        ...
        switch(deviceVersion) {
          case CAMERA_DEVICE_API_VERSION_1_0:
            if (effectiveApiLevel == API_1) {  // Camera1 API route
                ...
                *client = new CameraClient(cameraService, tmp, packageName, false, featureId,
...
Status CameraService::connect(
    ...
    ret = connectHelper(cameraClient, id, api1CameraId,
            CAMERA_HAL_API_VERSION_UNSPECIFIED, clientPackageName,/*systemNativeClient*/ false, {}, clientUid, clientPid, API_1,
...
Status CameraService::connectLegacy(
    ...
    ret = connectHelper<ICameraClient,Client>(cameraClient, id, api1CameraId, halVersion,
            ...
            /*shimUpdateOnly*/ false, /*oomScoreOffset*/ 0, __ANDROID_API_FUTURE__, /*out*/client);
...
Status CameraService::connectDevice(
    ...
    ret = connectHelper<hardware::camera2::ICameraDeviceCallbacks,CameraDeviceClient>(cameraCb, id,
            /*api1CameraId*/-1,
            CAMERA_HAL_API_VERSION_UNSPECIFIED, clientPackageNameAdj, systemNativeClient,clientFeatureId,
...
Status CameraService::connectHelper(const sp<CALLBACK>& cameraCb, const String8& cameraId,
    ...
    bool isNonSystemNdk = (clientPackageName.size() == 0);
    {
        ...
        if(!(ret = makeClient(this, cameraCb, clientPackageName, systemNativeClient,
                ...
                clientPid, clientUid, getpid(), halVersion,
