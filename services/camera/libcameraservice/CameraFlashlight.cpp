...
status_t CameraHardwareInterfaceFlashControl::turnOnTorchWithStrengthLevel(const String8& cameraId,
            int32_t torchStrength) {
    (void)cameraId;
    (void)torchStrengh;
    status_t res = OK;
...
status_t CameraHardwareInterfaceFlashControl::getTorchStrengthLevel(const String8& cameraId,
            int32_t* torchStrength) {
    (void)cameraId;
    (void)torchStrengh;
    status_t res = OK;
