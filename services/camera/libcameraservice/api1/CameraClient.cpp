...
CameraClient::CameraClient(const sp<CameraService>& cameraService,
        ...
        int servicePid):
        Client(cameraService, cameraClient, clientPackageName, false, clientFeatureId,
...
status_t CameraClient::injectCamera(const String8& injectedCamId,
